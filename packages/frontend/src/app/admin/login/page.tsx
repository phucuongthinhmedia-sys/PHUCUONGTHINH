  ...
  return (
    ...
    >
      ...
      <div className="max-w-md w-full px-6 relative z-10">
        {/* Nút quay lại trang chủ (Tinh tế ở góc trên) */}
        ...
        <div className="bg-white/60 backdrop-blur-xl rounded-[40px] shadow-[0_20px_60px_rgba(128,64,0,0.05)] border border-white/80 p-8 sm:p-10">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button
              ...
              disabled={isLoading}
              style={{ backgroundColor: palette.brown }}
              className="w-full mt-8 py-4 px-6 text-white text-[15px] font-bold rounded-full transition-all flex items-center justify-center gap-2 hover:bg-[#6e2411] hover:shadow-lg hover:-translate-y-0.5 disabled:opacity-70 disabled:pointer-events-none group"
            >
              {isLoading ? (
                <>
