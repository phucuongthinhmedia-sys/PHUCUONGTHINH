...
async function main() {
  ...
  // Delete existing products to ensure fresh data
  ...
  const floorTile1 = await prisma.product.create({
    data: {
      ...
      sku: 'GACH-FLOOR-001',
      description:
        'Gạch porcelain cao cấp nhập khẩu từ Ý với bề mặt bóng sang trọng, độ bền vượt trội. Phù hợp cho phòng khách, phòng ngủ, văn phòng và showroom. Công nghệ sản xuất hiện đại, chống trầy xước, chống thấm nước tuyệt đối.',
      ...
      technical_specs: JSON.stringify({
        ...
        // Hướng dẫn
        huong_dan_lap_dat:
          'Sử dụng keo dán gạch chuyên dụng cho porcelain. Khoảng cách mạch 2-3mm. Dùng ke nhựa để căn chỉnh. Chà rửa mạch sau 24 giờ với vữa chống thấm. Nên lắp đặt bởi thợ có kinh nghiệm.',
        bao_quan:
          'Bảo quản trong nơi khô ráo, tránh ánh nắng trực tiếp. Xếp chồng tối đa 5 túi. Tránh va đập mạnh.',
        ve_sinh:
          'Lau sàn hàng ngày bằng nước sạch hoặc dung dịch tẩy rửa nhẹ. Tránh dùng chất tẩy mạnh có acid.',
  ...
  const floorTile2 = await prisma.product.create({
    data: {
      ...
      sku: 'GACH-FLOOR-002',
      description:
        'Gạch porcelain giả gỗ tự nhiên nhập khẩu từ Tây Ban Nha, mang lại cảm giác ấm cúng cho không gian sống. Vân gỗ sống động, chống trơn tốt, dễ vệ sinh và bền lâu hơn sàn gỗ thật.',
      category_id: floorTilesCategory.id,
      technical_specs: JSON.stringify({
        chat_lieu: 'Porcelain (Sứ)',
        ...
        huong_dan_lap_dat:
          'Lắp đặt theo hướng dọc hoặc ngang tùy ý. Sử dụng keo chuyên dụng. Mạch 2mm. Có thể lắp đặt kiểu xương cá hoặc chữ I. Nên lắp đặt bởi thợ có kinh nghiệm.',
        bao_quan: 'Bảo quản nơi khô ráo, tránh ẩm ướt. Xếp chồng tối đa 6 túi.',
        ve_sinh:
          'Lau sàn bằng nước ấm và dung dịch tẩy rửa nhẹ. Không cần đánh bóng như sàn gỗ thật.',
  ...
  const floorTile3 = await prisma.product.create({
    data: {
      ...
      sku: 'GACH-FLOOR-003',
      description:
        'Gạch porcelain kiểu bê tông nhập khẩu từ Đức, phù hợp với phong cách công nghiệp và tối giản. Chống trơn cực tốt, có thể sử dụng cả ngoài trời. Độ bền cao, chịu lực tốt.',
      category_id: floorTilesCategory.id,
      technical_specs: JSON.stringify({
        chat_lieu: 'Porcelain (Sứ)',
        ...
        ung_dung:
          'Phòng khách, văn phòng, cửa hàng, không gian công cộng, ngoài trời',
        phong_cach: 'Công nghiệp, tối giản, hiện đại',

        huong_dan_lap_dat:
          'Phù hợp cho lắp đặt ngoài trời. Sử dụng keo chuyên dụng chống nước. Mạch 3-4mm. Có thể lắp đặt trên sân thượng, ban công. Nên lắp đặt bởi thợ có kinh nghiệm.',
  ...
  const wallTile1 = await prisma.product.create({
    data: {
      ...
      sku: 'GACH-WALL-001',
      description:
        'Gạch ốp tường phòng tắm sản xuất tại Việt Nam với bề mặt trơn bóng, chống ẩm mốc tốt, dễ vệ sinh. Phù hợp cho phòng tắm, nhà vệ sinh, nhà bếp. Giá thành hợp lý, chất lượng ổn định.',
      ...
      technical_specs: JSON.stringify({
        ...
        huong_dan_lap_dat:
          'Lắp đặt trên tường bằng keo chuyên dụng. Mạch 2mm. Cần chà rửa mạch sau 24 giờ. Có thể tự lắp đặt hoặc thuê thợ.',
        bao_quan: 'Bảo quản nơi khô ráo, tránh ẩm ướt trước khi lắp đặt.',
        ve_sinh:
          'Lau chùi bằng nước sạch hoặc dung dịch tẩy rửa nhẹ. Dễ dàng vệ sinh.',
  ...
  const wallTile2 = await prisma.product.create({
    data: {
      ...
      sku: 'GACH-WALL-002',
      description:
        'Gạch ốp tường nhà bếp sản xuất tại Việt Nam với màu xanh pastel nhẹ nhàng, tạo không gian tươi mới. Kích thước nhỏ dễ lắp đặt, phù hợp cho nhà bếp, phòng ăn, phòng tắm.',
      category_id: wallTilesCategory.id,
      technical_specs: JSON.stringify({
        chat_lieu: 'Ceramic (Gốm)',
        ...
        huong_dan_lap_dat:
          'Lắp đặt trên tường bằng keo chuyên dụng. Mạch 2mm. Dễ dàng cắt và lắp đặt. Có thể tự lắp đặt.',
  ...
  const wallTile3 = await prisma.product.create({
    data: {
      ...
      sku: 'GACH-WALL-003',
      description:
        'Gạch ốp tường trang trí sản xuất tại Việt Nam với họa tiết hoa tinh tế, tạo điểm nhấn cho không gian. Phù hợp làm điểm nhấn trong phòng tắm, nhà bếp, phòng ăn.',
      category_id: wallTilesCategory.id,
      technical_specs: JSON.stringify({
        chat_lieu: 'Ceramic (Gốm)',
        ...
        huong_dan_lap_dat:
          'Lắp đặt trên tường bằng keo chuyên dụng. Mạch 2mm. Có thể kết hợp với gạch trơn. Nên lắp đặt bởi thợ có kinh nghiệm.',
  ...
  const sanitaryWare1 = await prisma.product.create({
    data: {
      ...
      sku: 'VSWARE-001',
      description:
        'Bồn cầu thông minh nhập khẩu từ Hàn Quốc với nắp rửa tự động, sấy khô, điều chỉnh nhiệt độ nước. Tiết kiệm nước, vệ sinh tốt, phù hợp cho phòng tắm hiện đại. Công nghệ tiên tiến, sử dụng dễ dàng.',
      ...
      technical_specs: JSON.stringify({
        ...
        tinh_nang_nap_rua:
          'Nắp rửa tự động, sấy khô, điều chỉnh nhiệt độ nước, đèn LED ban đêm',
        ...
        huong_dan_lap_dat:
          'Cần lắp đặt bởi thợ chuyên nghiệp. Kết nối nước và điện 220V. Cần ống thoát nước chuẩn Φ110mm. Khoảng cách từ tường đến tâm thoát nước: 300-400mm.',
        bao_quan:
          'Bảo quản nơi khô ráo. Tránh va đập mạnh. Không để ngoài trời.',
        bao_tri:
          'Vệ sinh hàng ngày bằng nước sạch. Kiểm tra nắp rửa định kỳ 6 tháng/lần. Thay lọc nước 1 năm/lần.',
  ...
  const sanitaryWare2 = await prisma.product.create({
    data: {
      ...
      sku: 'VSWARE-002',
      description:
        'Chậu rửa tay treo tường sản xuất tại Việt Nam với thiết kế tối giản, tiết kiệm không gian, dễ vệ sinh. Phù hợp cho phòng tắm, nhà vệ sinh, phòng khách. Chất lượng tốt, giá thành hợp lý.',
      category_id: sanitaryWareCategory.id,
      technical_specs: JSON.stringify({
        chat_lieu: 'Sứ',
        ...
        huong_dan_lap_dat:
          'Treo tường bằng bu lông chuyên dụng. Chiều cao lắp đặt: 80-85cm từ sàn. Kết nối nước và thoát nước. Có thể tự lắp đặt hoặc thuê thợ.',
        bao_quan: 'Bảo quản nơi khô ráo trước khi lắp đặt. Tránh va đập.',
        bao_tri:
          'Vệ sinh hàng ngày bằng nước sạch. Kiểm tra kết nối nước định kỳ. Vệ sinh xi phông 3 tháng/lần.',
  ...
  const sanitaryWare3 = await prisma.product.create({
    data: {
      ...
      sku: 'VSWARE-003',
      description:
        'Bồn tắm massage nhập khẩu từ Thái Lan với hệ thống phun nước 12 vòi, tạo trải nghiệm thư giãn tuyệt vời. Điều chỉnh nhiệt độ, đèn LED, chế độ sủi bọt. Phù hợp cho phòng tắm cao cấp, spa tại nhà.',
      category_id: sanitaryWareCategory.id,
      technical_specs: JSON.stringify({
        ...
        tinh_nang:
          'Massage 12 vòi phun, điều chỉnh nhiệt độ, đèn LED RGB, chế độ sủi bọt, khử trùng Ozone',
        ...
        huong_dan_lap_dat:
          'Cần lắp đặt bởi thợ chuyên nghiệp. Cần sàn chắc chắn (chịu lực > 500kg). Kết nối nước nóng/lạnh, thoát nước Φ50mm và điện 220V. Cần không gian tối thiểu 2m x 1.2m.',
        bao_quan:
          'Bảo quản nơi khô ráo. Tránh va đập mạnh. Không để ngoài trời.',
        bao_tri:
          'Vệ sinh hàng ngày bằng nước sạch và dung dịch tẩy rửa nhẹ. Kiểm tra hệ thống phun nước định kỳ 6 tháng/lần. Thay lọc nước 6 tháng/lần. Vệ sinh bộ lọc bơm 3 tháng/lần.',
  ...
  const kitchenAppliance1 = await prisma.product.create({
    data: {
      ...
      sku: 'KITCHEN-001',
      description:
        'Bếp từ đôi sản xuất tại Trung Quốc với công suất cao 3500W, nấu nhanh, tiết kiệm điện, an toàn cho gia đình. Điều khiển cảm ứng, hẹn giờ, chế độ nấu nhanh. Phù hợp cho nhà bếp hiện đại.',
      ...
      technical_specs: JSON.stringify({
        ...
        tinh_nang:
          'Điều khiển cảm ứng, hẹn giờ 0-180 phút, chế độ nấu nhanh, chống tràn nước, khóa trẻ em, tự động tắt khi không có nồi',
        ...
        huong_dan_lap_dat:
          'Đặt trên mặt bàn bếp phẳng. Cần khoảng cách 10cm từ tường. Kết nối điện 220V. Sử dụng nồi có đáy từ tính. Có thể tự lắp đặt.',
        bao_quan:
          'Bảo quản nơi khô ráo. Tránh va đập. Không để nước vào bên trong.',
        bao_tri:
          'Vệ sinh bề mặt bằng khăn mềm sau mỗi lần sử dụng. Tránh để nước trên bề mặt. Kiểm tra dây điện định kỳ. Không dùng chất tẩy mạnh.',
  ...
  const kitchenAppliance2 = await prisma.product.create({
    data: {
      ...
      sku: 'KITCHEN-002',
      description:
        'Máy hút mùi âm tủ nhập khẩu từ Ý với thiết kế hiện đại, hút mùi mạnh 800m³/h, hoạt động yên tĩnh. Đèn LED tiết kiệm điện, điều khiển cảm ứng, 3 mức hút. Phù hợp cho nhà bếp hiện đại.',
      category_id: kitchenAppliancesCategory.id,
      technical_specs: JSON.stringify({
        ...
        tinh_nang:
          'Đèn LED 2x3W tiết kiệm điện, điều khiển cảm ứng, lọc dầu tái sử dụng bằng nhôm, hẹn giờ tự động tắt',
        ...
        huong_dan_lap_dat:
          'Lắp đặt âm tủ bếp. Chiều cao lắp đặt: 65-75cm từ mặt bếp. Cần ống thoát khí Φ150mm. Kết nối điện 220V. Nên lắp đặt bởi thợ chuyên nghiệp.',
        bao_quan: 'Bảo quản nơi khô ráo trước khi lắp đặt. Tránh va đập.',
        bao_tri:
          'Vệ sinh lọc dầu hàng tháng bằng nước nóng và dung dịch tẩy rửa. Thay lọc dầu 3-6 tháng/lần nếu cần. Kiểm tra ống thoát khí định kỳ. Vệ sinh bề mặt inox bằng khăn mềm.',
  ...
  const kitchenAppliance3 = await prisma.product.create({
    data: {
      ...
      sku: 'KITCHEN-003',
      description:
        'Lò nướng âm tủ nhập khẩu từ Đức với nhiều chức năng nấu, nướng, hấp. Công suất 3000W, nhiệt độ tối đa 250°C. Điều khiển cảm ứng, hẹn giờ, tự làm sạch. Phù hợp cho nhà bếp cao cấp.',
      category_id: kitchenAppliancesCategory.id,
      technical_specs: JSON.stringify({
        ...
        tinh_nang:
          'Chế độ nướng trên/dưới/2 chiều, hấp, nấu, quạt đối lưu, đèn LED bên trong, điều khiển cảm ứng, hẹn giờ 0-120 phút, tự làm sạch Pyrolytic',
        ...
        huong_dan_lap_dat:
          'Lắp đặt âm tủ bếp. Cần không gian tủ 600x600x600mm. Cần ống thoát khí. Kết nối điện 220V. Nên lắp đặt bởi thợ chuyên nghiệp.',
        bao_quan: 'Bảo quản nơi khô ráo trước khi lắp đặt. Tránh va đập.',
        bao_tri:
          'Vệ sinh bên trong sau mỗi lần sử dụng hoặc dùng chế độ tự làm sạch. Kiểm tra đèn LED định kỳ. Thay lọc khí 6-12 tháng/lần. Vệ sinh kính cửa bằng dung dịch tẩy rửa nhẹ.',
  ...
  // ========== THÊM SẢN PHẨM GẠCH TỪ BÁO GIÁ ==========
  const floorTile4 = await prisma.product.create({
    data: {
      name: 'Gạch Lát Nền 40x40 Ceramic Màu Ghi Xi Măng',
      sku: '4401357623',
      description:
        'Gạch lát nền ceramic 40x40 màu ghi xi măng, phong cách công nghiệp hiện đại. Bề mặt mờ chống trơn tốt, phù hợp cho phòng khách, phòng ngủ, văn phòng. Sản xuất tại Việt Nam với chất lượng ổn định, giá thành hợp lý.',
      category_id: floorTilesCategory.id,
      technical_specs: JSON.stringify({
        chat_lieu: 'Ceramic (Gốm)',
        ...
        huong_dan_lap_dat:
          'Sử dụng keo dán gạch chuyên dụng. Khoảng cách mạch 2-3mm. Dùng ke nhựa để căn chỉnh. Chà rửa mạch sau 24 giờ. Có thể tự lắp đặt hoặc thuê thợ.',
        bao_quan:
          'Bảo quản trong nơi khô ráo, tránh ánh nắng trực tiếp. Xếp chồng tối đa 6 túi.',
  ...
  const floorTile5 = await prisma.product.create({
    data: {
      ...
      sku: 'GACH-FLOOR-005',
      description:
        'Gạch granite 60x60 vân đá marble trắng sang trọng, bề mặt bóng cao cấp. Độ bền vượt trội, chống thấm nước tuyệt đối. Phù hợp cho phòng khách, sảnh, showroom, văn phòng cao cấp.',
      category_id: floorTilesCategory.id,
      technical_specs: JSON.stringify({
        ...
        huong_dan_lap_dat:
          'Sử dụng keo dán gạch chuyên dụng cho granite. Khoảng cách mạch 2-3mm. Chà rửa mạch sau 24 giờ. Nên lắp đặt bởi thợ có kinh nghiệm.',
        bao_quan:
          'Bảo quản trong nơi khô ráo, tránh ánh nắng trực tiếp. Xếp chồng tối đa 5 túi.',
        ve_sinh:
          'Lau sàn hàng ngày bằng nước sạch. Có thể đánh bóng định kỳ để giữ độ bóng.',
  ...
  const floorTile6 = await prisma.product.create({
    data: {
      ...
      sku: 'GACH-FLOOR-006',
      description:
        'Gạch porcelain 80x80 vân đá granite đen sang trọng, bề mặt bóng gương. Độ bền cao, chống trầy xước tốt. Phù hợp cho phòng khách, sảnh khách sạn, showroom cao cấp, văn phòng.',
      category_id: floorTilesCategory.id,
      technical_specs: JSON.stringify({
        chat_lieu: 'Porcelain (Sứ)',
        ...
        huong_dan_lap_dat:
          'Sử dụng keo dán gạch chuyên dụng cho porcelain. Khoảng cách mạch 2-3mm. Chà rửa mạch sau 24 giờ. Nên lắp đặt bởi thợ có kinh nghiệm.',
        bao_quan:
          'Bảo quản trong nơi khô ráo, tránh va đập. Xếp chồng tối đa 4 túi.',
        ve_sinh:
          'Lau sàn hàng ngày bằng nước sạch. Có thể đánh bóng định kỳ để giữ độ bóng gương.',
  ...
  const wallTile4 = await prisma.product.create({
    data: {
      ...
      sku: 'GACH-WALL-004',
      description:
        'Gạch ốp tường ceramic 30x60 vân đá marble sang trọng, bề mặt bóng. Phù hợp cho phòng tắm, nhà bếp, phòng khách. Chống ẩm mốc tốt, dễ vệ sinh. Sản xuất tại Việt Nam với chất lượng ổn định.',
      category_id: wallTilesCategory.id,
      technical_specs: JSON.stringify({
        chat_lieu: 'Ceramic (Gốm)',
        kich_thuoc: '300 x 600 x 8 mm',
        ...
        huong_dan_lap_dat:
          'Lắp đặt trên tường bằng keo chuyên dụng. Mạch 2mm. Chà rửa mạch sau 24 giờ. Có thể tự lắp đặt hoặc thuê thợ.',
        bao_quan: 'Bảo quản nơi khô ráo, tránh ẩm ướt trước khi lắp đặt.',
  ...
  const wallTile5 = await prisma.product.create({
    data: {
      ...
      sku: 'GACH-WALL-005',
      description:
        'Gạch mosaic thủy tinh 30x30 màu xanh dương, tạo điểm nhấn cho không gian. Phù hợp cho phòng tắm, bể bơi, spa. Chống nước tuyệt đối, màu sắc bền đẹp. Nhập khẩu từ Trung Quốc.',
      category_id: wallTilesCategory.id,
      technical_specs: JSON.stringify({
        ...
        huong_dan_lap_dat:
          'Lắp đặt trên tường bằng keo chuyên dụng cho mosaic. Mạch 1-2mm. Chà rửa mạch sau 24 giờ với vữa chống thấm. Nên lắp đặt bởi thợ có kinh nghiệm.',
        bao_quan: 'Bảo quản nơi khô ráo, tránh va đập.',
  ...
  const mediaData = [
    ...
    // Floor Tile 4 - Gạch 40x40 Ghi Xi Măng
    {
    ...
    // Floor Tile 5 - Granite Marble Trắng
    {
    ...
    // Floor Tile 6 - Porcelain Granite Đen
    {
    ...
    // Wall Tile 4 - Ceramic Vân Marble
    {
