import { apiClient, rawApiClient } from "./api-client";
...
// Raw shape backend actually returns
...
class ProductService {
  async getProducts(
    ...
    // Use getRaw so we get the full { success, data, pagination } shape
    // instead of the auto-unwrapped data array
